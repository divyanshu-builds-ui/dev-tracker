    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-10 relative z-10">
          ...
          <button
            onClick={loginGithub}
            className="px-8 py-4 rounded-2xl text-sm font-semibold flex items-center justify-center gap-3 bg-[#0d1117] text-white border border-white/[0.1] active:scale-95 transition-transform">
      ...
      <section className="px-4 py-20 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <button
            onClick={loginGoogle}
            className="btn-premium px-10 py-4 rounded-2xl text-sm font-semibold inline-flex items-center gap-2 active:scale-95 transition-transform">
            🚀 Get Started — Free
          </button>
        </motion.div>
